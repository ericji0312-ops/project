      ...
      <section className="space-y-2 border rounded p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              className="text-xs rounded px-2 py-1 bg-red-600 text-white cursor-pointer transition-colors duration-150 hover:bg-red-700 hover:shadow-md disabled:cursor-not-allowed disabled:pointer-events-none disabled:shadow-none disabled:bg-gray-100 disabled:text-gray-400 dark:disabled:bg-neutral-900 dark:disabled:text-neutral-600"
            ...
            <button
              className="text-xs rounded px-2 py-1 bg-amber-500 text-white cursor-pointer transition-colors duration-150 hover:bg-amber-600 hover:shadow-md disabled:cursor-not-allowed disabled:pointer-events-none disabled:shadow-none disabled:bg-gray-100 disabled:text-gray-400 dark:disabled:bg-neutral-900 dark:disabled:text-neutral-600"
