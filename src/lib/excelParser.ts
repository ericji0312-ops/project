...
const TYPE_RULES: { pattern: RegExp; type: string }[] = [
  ...
  { pattern: /개념/, type: "개념" },
  // RPM류 커리큘럼 원본에서 개념 회차 라벨의 "개념" 접미사가 종종 빠져
  // "중3_1학기"처럼 학기명만 남는 오탈자가 있다(예: "중3_1학기 : 5.제곱근 개념 익히기 문제 풀기").
  // 라벨만 다를 뿐 내용상 개념 학습 항목이므로 같은 회차의 개념 열로 합친다.
  { pattern: /학기$/, type: "개념" },
  { pattern: /라이트쎈/, type: "라이트쎈" },
  // "실전 트레이닝"은 라이트쎈 라벨 없이 단독으로 적힌 파일도 있는데(예: "실전 트레이닝 : 120~137번 풀기"),
  // 전체 커리큘럼 파일을 조사해보면 "실전 트레이닝"은 항상 라이트쎈의 하위 항목으로만 쓰인다
  // ("연산 트레이닝"은 별개로 이미 위의 /연산/ 규칙에서 잡힘).
  { pattern: /실전\s*트레이닝/, type: "라이트쎈" },
  { pattern: /쎈/, type: "쎈" },
